...
public final class GlobalVars {
    private PluginConcept holder = SLPluginEnvironment.getApplication();
    ...
    public void setHolder(PluginConcept holder) {
        this.holder = holder;
    }

    private File getExternalFile() {
        FilePath.tryReleaseAndGetFile(
                "/templates/global_vars.yml",
                FilePath.pluginFolder(SLPluginEnvironment.getPluginId()) + "/global_vars.yml"
        );
        return new File(FilePath.pluginFolder(SLPluginEnvironment.getPluginId()) + "/global_vars.yml");
    }
