...
public final class HoverDisplay extends SLPackageModule implements PluginCommandExecutor {
    ...
    public static final class VirtualArmorStand extends LocationBasedObject {
    ...
    public static final class HoverDisplayStorageService extends RegionalLocatedDataService<VirtualArmorStand> {
