...
public interface ChatSender {
    static MessageHandler getImpl() {
        try {
            ...
            return new ChatSender.SystemChatImpl();
        } catch (Throwable e) {
            try {
                Class.forName("com.comphenix.protocol.wrappers.EnumWrappers$ChatType");
                return new ChatSender.ChatTypeImpl();
            } catch (Throwable ee) {
                return new ChatSender.LegacyImpl();
            }
        }
    }

    final class SystemChatImpl extends MessageHandler {
    ...
    final class ChatTypeImpl extends MessageHandler {
    ...
    final class LegacyImpl extends MessageHandler {
