...
public final class GlobalVars {
    private Plugin holder = Starlight.instance();
    ...
    private File getExternalFile() {
        FilePath.tryReleaseAndGetFile("/templates/global_vars.yml", FilePath.pluginFolder(ProductInfo.PLUGIN_ID) + "/global_vars.yml");
        return new File(FilePath.pluginFolder(ProductInfo.PLUGIN_ID) + "/global_vars.yml");
    }
